...
def main():
    ...
    for nidx, n in enumerate(nvec):
        ...
        for didx, d in enumerate(dvec):
            ...
            for i in range(sample):
                ...
                if flag:
                    fname = 'minnrm_normal_n{}_d{}_w{}_X{}_sig{}_sample{}'.format(n, d, optw, optx, sigma, i)
    ...
    fname = 'minnrm_n{}_d{}_w{}_X{}_sig{}_sample{}'.format(args.n, args.d, optw, optx, sigma, sample)
